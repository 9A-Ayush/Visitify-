    ...
    async submitRegistration() {
        ...
        try {
            ...
            const visitorData = {
                ...
                valid_until: this.currentInvitation.valid_until,
                photo_url: null // TODO: Handle photo upload
            };

            // Save visitor to Firestore
            const docRef = await db.collection('visitors').add(visitorData);
            
            // Send notifications
            await this.sendNotifications(visitorData, docRef.id);
    ...
    async sendNotifications(visitorData, visitorId) {
        try {
            ...
            const guardNotification = {
                ...
                message: `${visitorData.name} has registered to visit ${visitorData.visiting_flat}`,
            ...
            // Create notification for resident/host
            const residentNotification = {
                type: 'visitor_arrival',
                title: 'Visitor Registered',
                message: `${visitorData.name} has registered for their visit`,
                visitor_id: visitorId,
                visitor_name: visitorData.name,
    ...
    showSuccess(visitorData) {
        ...
        successDetails.innerHTML = `
            ...
            <p style="color: #4CAF50; font-weight: bold; margin-top: 1rem;">
                The guard and resident have been notified of your arrival.
            </p>
        `;
        this.showScreen('success-screen');
        this.showToast('Registration successful! Notifications sent.', 'success');
    }
